...
mixin _$PrescriptionModel {
  ...
  String? get userDoctorId => throw _privateConstructorUsedError;
  @TimestampConverter()
    ...
    return _then(_value.copyWith(
      ...
      userId: freezed == userId
          ...
          : userId // ignore: cast_nullable_to_non_nullable
              as String?,
      userDoctorId: freezed == userDoctorId
          ? _value.userDoctorId
          : userDoctorId // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$PrescriptionModelImpl implements _PrescriptionModel {
  ...
  @override
  String toString() {
    return 'PrescriptionModel(id: $id, timeSlotId: $timeSlotId, doctorId: $doctorId, userId: $userId, userDoctorId: $userDoctorId, createdAt: $createdAt, prescription: $prescription)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.userDoctorId, userDoctorId) ||
                other.userDoctorId == userDoctorId) &&
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, timeSlotId, doctorId, userId,
      userDoctorId, createdAt, prescription);
