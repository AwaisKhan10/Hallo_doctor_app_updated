...
class AuthService {
  ...
  Future regiterNewUser(
      String username, int phoneNumber, String email, String password) async {
    try {
      ...
      await FirebaseService().userSetup(result.user!, username, phoneNumber);
    } on FirebaseAuthException catch (e) {
      return Future.error(e.message!);
