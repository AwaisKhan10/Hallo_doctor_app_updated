const Map<String, String> en = {
  ...
  'Name must be more than two characters':
      'Name must be more than two characters',
  'Sports Name e.g : Sachin': 'Sports Name e.g : Sachin',
  'the sports ground, where you work': 'the sports, where you work',
  'Short Biography': 'Short Biography',
  'Chose Doctor Category': 'Chose Sports Category',
  'Save': 'Save',
  'Doctor Category': 'Sports Category',
  'Search': 'Search',
  ...
  'Please chose doctor Specialty or Category':
      'Please chose sports Specialty or Category',
  'loading...': 'loading...',
  ' Minute': ' Minute',
  'Every Day': 'Every Day',
